                ...
                <div class="col-sm-8">
                    <div class="left">
                        <div class="left_main">
                            ...
                            <div class="img-div" id="img-div"><img src="<?= base_url('uploads/admin/').$map->image ?>" id="myImg"  style="cursor:pointer" onclick="onClick(this)" class="modal-hover-opacity">
                                <h1><?= $map->title ?>
                                </h1>
                                <div class="icons_count">
                                 
                                </div>
                                <a href="<?= base_url() ?>/maps/<?= $map->route_name ?>" class="read_more">مزید پڑھیں
                                </a>
                            </div>
                            <?php endforeach; ?>
                            <?php }else { ?>
     ...
     <section class="section4_load_more">
        <div class="container">
            <div class="section_load_more">
                <div class="left_main">
                   <div class="row justify-content-md-center">
                        <div class="col-sm-6"> <div class="img-div" id="img-div"><img src="../Assets/Images/map1.jpg" id="myImg" style="cursor:pointer" onclick="onClick(this)" class="modal-hover-opacity">
                            ...
                            </div> <div class="img-div" id="img-div"><img src="../Assets/Images/map1.jpg" id="myImg" style="cursor:pointer" onclick="onClick(this)" class="modal-hover-opacity">
                                <h1>اس کی سب سے بڑی حد تک اموی خلافت کا نقشہ ، 750 عیسوی
                                </h1>
                                <div class="icons_count">
                                    <i class="fas fa-eye">1.5K</i>
                        ...
                        <div class="col-sm-6">
                            <div class="img-div" id="img-div"><img src="../Assets/Images/map1.jpg" id="myImg" style="cursor:pointer" onclick="onClick(this)" class="modal-hover-opacity">
                                <h1>اس کی سب سے بڑی حد تک اموی خلافت کا نقشہ ، 750 عیسوی
                                </h1>
                                <div class="icons_count">
                                    <i class="fas fa-eye">1.5K</i>
