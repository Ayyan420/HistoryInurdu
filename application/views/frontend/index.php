...
<body>
    ...
    <source src="<?= base_url('assets/frontend/music/') ?>HIUBackgroundmusic.mp3" type="audio/mpeg">
    ...
    <section class="section_svg">
        <div class="container">
            <div class="center_title_svg">
                <h1>ایک شام اعلیٰ ظرف تاریخِِ گو, تاریخِِ ساز </h1>
                <h2> اور تاریخِِ دانوں کے نام</h2>
                <img src="<?= base_url('assets/frontend') ?>/Images/bar_12-01.svg" width="220px">
            </div>
        </div>
    </section>
    <div class="section2" >
        <div class="container-fluid">
            <div class="center_section2">
                ...
                <img src="<?= base_url('assets/frontend') ?>/Images/bar_22222-01.svg" class="bar">
                <div class="sub_section2_images">
                    <figure class="snip1529" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <figure class="snip1529 hover" data-aos="fade-down" data-aos-delay="0"><img src="<?= base_url('assets/frontend') ?>/Images/Seljuq Empire.png" alt="pr-sample21" />
                    ...
                    <figure class="snip1529" data-aos="fade-right" data-aos-delay="0"><img src="<?= base_url('assets/frontend') ?>/Images/Al Fateh.jpg" alt="pr-sample23" />
                        <div class="date"><span class="day">08</span><span class="month">جون</span></div>
                        <figcaption>
                            <h3>سلطنت عثمانیہ</h3>
                            <p>سلطنت عثمانیہ ایک ایسی ریاست تھی جس نے 14 ویں 20 ویں صدی کے درمیان جنوب مشرقی یورپ </p>
                        </figcaption>
                        <!--  <div class="hover"><i class="fas fa-location-arrow"></i></div> -->
                        <a href="#"></a>
                    </figure>
                    <figure class="snip1529" data-aos="fade-up" data-aos-delay="0"><img src="<?= base_url('assets/frontend') ?>/Images/Ameer Taimoor Part 01 Thumbnail.png" alt="pr-sample23" />
                        <div class="date"><span class="day">08</span><span class="month">جولائی</span></div>
                        <figcaption>
                            <h3>تیمور کا عروج</h3>
                            <p>تیمور یوریشین اسٹیپی کے عظیم خانہ بدوش فاتحوں میں آخری تھا ، اور اس کی سلطنت نے مزید منظم </p>
                        </figcaption>
                        <!--  <div class="hover"><i class="fas fa-location-arrow"></i></div> -->
                        <a href="Pages/post.html"></a>
                    </figure>
                    <figure class="snip1529" data-aos="fade-left" data-aos-delay="0"><img src="<?= base_url('assets/frontend') ?>/Images/Fall of Ayubid Dynasty Thumbnail.png" alt="pr-sample23" />
                        <div class="date"><span class="day">08</span><span class="month">ستمبر</span></div>
                        <figcaption>
                            <h3>سلطان صلاح الدین ایوبی</h3>
                            <p>الناصر صلاح الدین یوسف ابن ایوب ، جسے صلاح صلاح یا صلاح الدین کے نام سے جانا جاتا ہے </p>
                        </figcaption>
    ...
    <section class="section3">
        <div class="container">
            <h1>تاریخی کتابیں</h1>
            <img src="<?= base_url('assets/frontend') ?>/Images/bar_22222-01.svg" class="bar2">
            <div class="categories-circle-center">
            <div id="owl-demo">

                <div class="item1 items ">
                    <a href="Pages/post_books.html">
                        <img src="<?= base_url('assets/frontend') ?>/books/Ameer Timur Book pdf.png">
                        <h5>امیر تیمور</h5>
                        <a href="Pages/book_4.html" class="download">ڈاؤن لوڈ کریں
                        </a>
                    </a>
                </div>
                <div class="item1 items ">
                    <a href="Pages/post_books.html">
                        <img src="<?= base_url('assets/frontend') ?>/books/Tipu Sultan.png">
                        <h5>ٹیپو سلطان
                        </h5>
                        <a href="Pages/book_1.html" class="download">ڈاؤن لوڈ کریں
                        </a>
                    </a>
                </div>
                <div class="item1 items ">
                ...
                <div class="item1 items ">
                    <a href="Pages/post_books.html">
                        <img src="<?= base_url('assets/frontend') ?>/books/Babur.png">
                        <h5>ظہیرالدین بابر
                        </h5>
                        <a href="Pages/book_3.html" class="download">ڈاؤن لوڈ کریں
                        </a>
                    </a>
                </div>
                <div class="item1 items ">
                    <a href="Pages/post_books.html">
                        <img src="<?= base_url('assets/frontend') ?>/books/Sultan Salahudeen Bood pdf.png">
                        <h5>صلاح الدین ایوبی
                        </h5>
                        <a href="Pages/book_2.html" class="download">ڈاؤن لوڈ کریں
                        </a>
                    </a>
                </div>
                <div class="item1 items ">
    ...
    <section class="section4">
        <div class="container-fluid">
            ...
            <img src="<?= base_url('assets/frontend') ?>/Images/bar_22222-01.svg" class="bar3"> <div class="row justify-content-md-center row_divs">
                <div class="col-sm-8 d-flex  col_left_sidebar">
...
<p>مزید پڑھنے کے لئے کلک کریں</p> -->
            ...
            <div class="col-sm-4 d-flex col_sidebar">
                     <div class="recipes_items_sidebar" id="fade-up">
                     ...
                     <div class="sidebar_2 sidebar_2_custom">
                            ...
                            <a href="Pages/Categories_books.html">
                                <div class="sidebar-items">
                                    ...
                                    <div class="right">
                                       <h2>
                                        صلاح الدین ایوبی کی سلطنت آخر کر مسلمانوں کے ہاتھوں کیوں تباہ ہوئیں
                                    </h2><small>مارچ 2021</small>
                                    </div>
                                </div>
                            </a>
                            <a href="Pages/Categories_books.html">
    ...
    <section class="section_testimonials">
        <div class="container">
              <div class="row justify-content-md-center text">
                    ...
                    <img src="<?= base_url('assets/frontend') ?>/Images/bar_22222-01.svg" class="bar5">
                    <div id="testimonial-slider" class="owl-carousel">
                         <div class="testimonial">    <div class="testimonial-content">
                                                        <p class="description">
                            ...
                            <div class="testimonial-profile">
                                <div class="pic">
                                    <img src="<?= base_url('assets/frontend') ?>/Images/photo_placeholder.jpg" alt="user">
                                </div>
                        ...
                        <div class="testimonial">
                                                <div class="testimonial-content">
                                                        <p class="description">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt, autem nulla reiciendis architecto quis unde nobis reprehenderit exercitationem. Autem, sed? Quis facere sapiente delectus est quo hic debitis dolorum accusamus.
                                </p>
                            </div>
                            <div class="testimonial-profile">
                                <div class="pic">
    ...
    <section class="section_semi_footer">
        <div class="container-fluid">
            <div class="row justify-content-md-center semi_row ml-2 mr-2">
                <div class="col-sm-4 d-flex justify-content-center mt-4 mt-4 logo_footer">
                    <div class="first_semi_footer">
                        <h1>ہمارے بارے میں
                        </h1>
                        <p>
...
<div class="col-sm-4 d-flex justify-content-center mt-4 mt-4 social_footer">
<div class="scnd_semi_footer_main">
                        <h1>ہمارے سوشل چینلز میں شامل ہوں
                        </h1>
                        <div class="scnd_semi_footer_1">
                            <div class="scnd_semi_footer_1_main">
                                <div class="left_scnd_semi_footer_1"><img src="<?= base_url('assets/frontend') ?>/Images/facebook.svg" alt="facebook"></div>
                                <div class="right_scnd_semi_footer_2">
                                    <h4>ہمیں فیس بک پر جوائن کریں
                                    </h4> <a href="#">https://www.google.com/search</a>
                                </div>
                            </div>
                        </div>
                        <div class="scnd_semi_footer_1 instagram_section">
                            <div class="scnd_semi_footer_1_main">
                                <div class="left_scnd_semi_footer_1"><img src="<?= base_url('assets/frontend') ?>/Images/instagram.svg" alt="instagram"></div>
                                <div class="right_scnd_semi_footer_2">
                                    <h4> ہمیں انسٹاگرام پر جوائن کریں</h4><a href="#">https://www.google.com/search</a>
                                </div>
                            </div>
                        </div>
                        <div class="scnd_semi_footer_1 youtube_section">
                            <div class="scnd_semi_footer_1_main youtube_bg">
                                <div class="left_scnd_semi_footer_1 "><img src="<?= base_url('assets/frontend') ?>/Images/youtube.svg" alt="youtube"></div>
                                <div class="right_scnd_semi_footer_2">
                                    <h4> ہمیں یوٹیوب پر جوائن کریں </h4> <a href="#">https://www.google.com/search</a>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 d-flex justify-content-center mt-4 mt-4">
                    <div class="semi_footer_last_main youtube_bg">
                        <h1>مفید لنکس
                        </h1>
                        <ul>
                            <li><a href="index.html">ہوم  </a></li>
                            <li><a href="Pages/Categories_taareekh-e-aalim.html">تارِیخِ عالَم</a></li>
                            <li><a href="Pages/blog.html">بلاگ</a></li>
                            <li><a href="Pages/contact-us.html">رابطہ کریں</a></li>
                            <li><a href="Pages/map.html">نقشہ</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="progress-wrap">
        <svg height="100%" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;" version="1.1" viewBox="0 0 100 126" width="100%" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/"
