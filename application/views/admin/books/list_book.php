                                ...
                                <?php foreach ($posts as $post): ?>
                                        <tr>
                                           ...
                                           <?php endforeach; ?>
                                            ...
                                            <td>
                                                <a href="edit_book/<?=  $post->id ?>" class="btn btn-success"  style="display: inline;">Edit</a>
                                                <a href="delete_book/<?=  $post->id ?>" class="btn btn-danger" style="display: inline;">Delete</a>
                                            </td>
