...
class Admin extends CI_Controller {
    ...
    public function delete_map($id){
        $result = $this->Admin_model->delete_map($id);
        if($result){
            $this->session->set_flashdata('success_message', 'Map deleted successfully.');
	...
	public function add_post(){
		$data['categore'] = $this->Admin_model->get_all_categories();
    ...
    public function delete_post($id){
        $result = $this->Admin_model->delete_post($id);
        if($result){
            $this->session->set_flashdata('success_message', 'Post deleted successfully.');
            redirect('admin/list-post');
        }else{
            $this->session->set_flashdata('error_message', 'Database error occure.');
            redirect('admin/list-post');
    ...
    public  function get_all_book_categories(){
        if($result = $this->db->get('book_category')->result_array()){
            return $result;
        }else{
            return false;
        }
	...
	public function add_book(){
		...
		$data['categore'] = $this->get_all_book_categories();
    ...
    public function delete_book($id){
        $result = $this->Admin_model->delete_book($id);
        if($result){
            $this->session->set_flashdata('success_message', 'Book deleted successfully.');
            redirect('admin/list-book');
        }else{
            $this->session->set_flashdata('error_message', 'Database error occure.');
            redirect('admin/list-book');
    ...
    public function approve_comment($id){
        $result = $this->Admin_model->approve_comment($id);
        if($result){
            $this->session->set_flashdata('success_message', 'Comment Approved successfully.');
            redirect('admin/comment');
        }else{
            $this->session->set_flashdata('error_message', 'Database error occure.');
            redirect('admin/comment');
    ...
    public function unapprove_comment($id){
        $result = $this->Admin_model->unapprove_comment($id);
        if($result){
            $this->session->set_flashdata('success_message', 'Comment Disapproved successfully.');
            redirect('admin/comment');
        }else{
            $this->session->set_flashdata('error_message', 'Database error occure.');
            redirect('admin/comment');
